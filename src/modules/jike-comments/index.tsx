...
import { columns } from '@/components/table/columns-jike-comment';
...
import { JikeCommentsInterceptor } from './api';

export default class JikeCommentsModule extends Extension {
  name = 'jike-comments';
  type = ExtensionType.JIKE_COMMENT;
  intercept = () => JikeCommentsInterceptor;
      ...
      return (
        ...
        >
          ...
          >
            <BaseTableView
              title={title}
              records={(records as JikeComment[]) ?? []}
              columns={columns}
