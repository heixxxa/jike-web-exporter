  ...
  public errorWithBanner(msg: string, err?: Error, ...args: LogExtraArgs) {
    this.error(
      `${msg} (Message: ${err?.message ?? 'none'})\n` +
        '  This may be a problem caused by website API updates.\n  Please file an issue on GitHub:\n' +
        '  https://github.com/heixxxa/jike-web-exporter/issues',
      ...args,
    );
  }

  public debug(...args: LogExtraArgs) {
    console.debug('[jike-web-exporter]', ...args);
  }
