...
import { JikePostDetailInterceptor } from './api';

export default class JikePostDetailModule extends Extension {
  name = 'jike-post-detail';
  type = ExtensionType.JIKE_POST;
  intercept = () => JikePostDetailInterceptor;
