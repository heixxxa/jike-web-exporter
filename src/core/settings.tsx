          ...
          <label class={styles.item}>
            <div class="flex items-center">
              ...
              <a
                class="tooltip tooltip-bottom ml-0.5 before:max-w-40"
                data-tip={t(
                  'This will create separate database for each Jike account, which can help reduce the chance of data mixing when you use multiple accounts.',
                )}
              >
                <IconHelp size={20} />
              </a>
            ...
            <div class="flex">
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  if (blob) {
                    saveFile(`jike-web-exporter-${Date.now()}.json`, blob);
                  }
                }}
              >
